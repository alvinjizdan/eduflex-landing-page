...
export function RoleMockupPreview({ role }: RoleMockupPreviewProps) {
  if (role === "superadmin") {
    return (
      <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 space-y-5 text-left shadow-card">
        {/* Header Controls */}
      ...
      <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 space-y-5 text-left shadow-card">
        ...
        <div className="space-y-3">
          <div className="p-3.5 rounded-xl bg-slate-950/70 border border-slate-800 flex items-center justify-between">
            ...
            <button className="inline-flex items-center gap-1 text-[11px] font-medium text-slate-300 bg-slate-800 hover:bg-slate-700 px-2.5 py-1 rounded border border-slate-700 transition-colors">
    ...
    <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 space-y-5 text-left shadow-card">
      ...
      <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-mono text-emerald-400">80% Progress</span>
        </div>
