...
export function TrustAssurance() {
  return (
    <div className="pt-12 space-y-6 text-left">
      <div className="border-t border-slate-200 dark:border-slate-800/80 pt-12 pb-4">
        <h3 className="text-h3 text-slate-900 dark:text-slate-100 font-bold">
          Product Assurance Principles
        </h3>
        <p className="text-body-small text-slate-600 dark:text-slate-400 mt-1">
          EduFlex is engineered around four core enterprise product assurance principles.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {trustPillars.map((pillar) => (
          <Card
            ...
            variant="default"
            hover
            className="p-6 space-y-4 border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/50 flex flex-col justify-between"
          >
            <div className="space-y-3">
              ...
              <p className="text-body-small text-slate-600 dark:text-slate-400 leading-relaxed">
                {pillar.description}
              </p>
            </div>
          </Card>
